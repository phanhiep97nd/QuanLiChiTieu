...
<head runat="server">
	...
	<script>
		...
		function submitIncome() {
			...
			var dateIncome = document.getElementById("DateLoan");
		...
		<div class="pos-f-t">
			...
			<div class="collapse" id="navbarToggleExternalContent">
				<div class="list-group">
					<asp:Button ID="HomeBtn" runat="server" CssClass="list-group-item list-group-item-info list-group-item-action" Text=" > Home" /><%--<button type="button" class="list-group-item list-group-item-info list-group-item-action">> Home</button>--%>
				...
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<div class="form-group">
							...
							<asp:TextBox ID="HumanLoan" runat="server" CssClass="form-control" ></asp:TextBox>
							<div id="validationServerUsernameFeedback" class="invalid-feedback">
